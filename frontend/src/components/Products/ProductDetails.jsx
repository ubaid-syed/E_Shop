        ...
        <div className="w-full block 800px:flex p-5">
          <div className="w-full 800px:w-[50%]">
            ...
            <p className="pt-2">
              ...
              Perspiciatis nisi quos quia vel modi, animi molestiae laudantium
              officia excepturi blanditiis asperiores accusantium, voluptatibus
              doloremque suscipit ab dolor, voluptates aperiam quaerat!
            </p>
          </div>
